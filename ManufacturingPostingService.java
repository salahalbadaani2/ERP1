...
public final class ManufacturingPostingService {
    ...
    public static boolean postMaterialIssue(MaterialIssueNote note, String wipAccount, String rawMaterialAccount) {
        ...
        return PostingEngine.postJournalEntry(entry, connection -> insertMaterialIssue(
                connection, note, wipAccount, rawMaterialAccount));
    }
    ...
    public static boolean postFinishedGoods(ProductionCompletionNote note) {
        ...
        return PostingEngine.postJournalEntry(entry, connection -> insertFinishedGoods(
                connection, note));
    }
    public static boolean postGoodsReceipt(GoodsReceiptNote note) {
        ...
        return PostingEngine.postJournalEntry(entry, connection -> insertGoodsReceipt(
                connection, note));
    }
    ...
    public static boolean applyOverhead(String productionOrder, String wipAccount,
        ...
        JournalEntry entry = new JournalEntry(
                "JV-FOH-" + productionOrder, productionOrder, "INVENTORY",
    ...
    public static boolean closeOverheadVariance(OverheadClosing closing) {
        ...
        return PostingEngine.postJournalEntry(entry, connection -> insertOverheadClosing(
                connection, closing));
    }
